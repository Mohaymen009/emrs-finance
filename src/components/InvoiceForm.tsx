...
export function InvoiceForm({ formData, onChange, onDownload }: InvoiceFormProps) {
  ...
  const recalc = (next: InvoiceData): InvoiceData => {
  ...
  const handleInputChange = (field: keyof InvoiceData, value: string | boolean) => {
    onChange(recalc({ ...formData, [field]: value } as InvoiceData));
  };

  const handleBankChange = (field: keyof InvoiceData["bankDetails"], value: string) => {
    onChange({
      ...formData,
  ...
  const handleContactChange = (field: keyof InvoiceData["contactDetails"], value: string) => {
    onChange({
      ...formData,
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            >
              <div className="flex items-center space-x-2">
                ...
                <Label htmlFor="ct-business" className="cursor-pointer">Business / Client (5% VAT)</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="individual" id="ct-individual" />
                <Label htmlFor="ct-individual" className="cursor-pointer">Individual (0% VAT)</Label>
              </div>
            </RadioGroup>
          </div>
          {formData.clientType === "individual" && (
            <p className="text-xs text-muted-foreground bg-muted/50 rounded-md px-3 py-2">
              Individual invoice — no company bill-to name required. The invoice will display a generic recipient.
            </p>
          )}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              placeholder="Enter client's complete billing address including street, city, country, PO box, VAT number, etc."
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="amountDue" className="font-semibold">
                Amount Due
              </Label>
              <Input
                id="amountDue"
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input
                id="providerName"
                value={formData.bankDetails.providerName}
                onChange={(e) => handleBankChange("providerName", e.target.value)}
              />
            </div>
            <div className="space-y-2">
              ...
              <Input
                ...
                value={formData.bankDetails.beneficiaryAccountName}
                onChange={(e) => handleBankChange("beneficiaryAccountName", e.target.value)}
              />
            </div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                value={formData.bankDetails.beneficiaryAccountNumber}
                onChange={(e) => handleBankChange("beneficiaryAccountNumber", e.target.value)}
              />
            </div>
            <div className="space-y-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                value={formData.contactDetails.companyAddress}
                onChange={(e) => handleContactChange("companyAddress", e.target.value)}
              />
            </div>
            <div className="space-y-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                value={formData.contactDetails.contactPersonDesignation}
                onChange={(e) => handleContactChange("contactPersonDesignation", e.target.value)}
              />
            </div>
            <div className="space-y-2">
              <Label htmlFor="contactPersonEmail">Email ID</Label>
              <Input
                id="contactPersonEmail"
                type="email"
                value={formData.contactDetails.contactPersonEmail}
                onChange={(e) => handleContactChange("contactPersonEmail", e.target.value)}
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                value={formData.contactDetails.authorizedSignatoryName}
                onChange={(e) => handleContactChange("authorizedSignatoryName", e.target.value)}
              />
            </div>
            <div className="space-y-2">
              ...
              <Input
                ...
                value={formData.contactDetails.authorizedSignatoryDesignation}
                onChange={(e) => handleContactChange("authorizedSignatoryDesignation", e.target.value)}
              />
            </div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              <Label htmlFor="authorizedSignatoryMobile">Mobile Number</Label>
              <Input
                id="authorizedSignatoryMobile"
                value={formData.contactDetails.authorizedSignatoryMobile}
                onChange={(e) => handleContactChange("authorizedSignatoryMobile", e.target.value)}
              />
            </div>
            <div className="space-y-2">
              <Label htmlFor="authorizedSignatoryEmail">Email ID</Label>
              <Input
                id="authorizedSignatoryEmail"
                type="email"
                value={formData.contactDetails.authorizedSignatoryEmail}
                onChange={(e) => handleContactChange("authorizedSignatoryEmail", e.target.value)}
              />
            </div>
          </div>
        </CardContent>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center space-x-2">
            <Checkbox
              ...
              onCheckedChange={(checked) => handleInputChange("includeStamp", !!checked)}
            />
          ...
          <div className="flex items-center space-x-2">
            <Checkbox
              ...
              onCheckedChange={(checked) => handleInputChange("isTaxDocument", !!checked)}
            />
            <Label htmlFor="isTaxDocument" className="cursor-pointer">
              Label as <span className="font-semibold">Tax Invoice</span> (uncheck for plain &quot;Invoice&quot;)
            </Label>
          </div>
          <div className="flex items-center space-x-2">
            <Checkbox
              ...
              onCheckedChange={(checked) => handleInputChange("hideCompanyTRN", !!checked)}
            />
