...
export function QuotationForm({ formData, onChange, onDownload }: QuotationFormProps) {
  ...
  const handleInputChange = (field: keyof QuotationData, value: string | boolean) => {
    onChange(recalc({ ...formData, [field]: value } as QuotationData));
  };

  const handleBankChange = (field: keyof QuotationData["bankDetails"], value: string) => {
    onChange({
      ...formData,
  ...
  const handleContactChange = (field: keyof QuotationData["contactDetails"], value: string) => {
    onChange({
      ...formData,
          ...
          <div className="space-y-2">
            ...
            >
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="business" id="qct-business" />
                <Label htmlFor="qct-business" className="cursor-pointer">Business / Client (5% VAT)</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="individual" id="qct-individual" />
                <Label htmlFor="qct-individual" className="cursor-pointer">Individual (0% VAT)</Label>
              </div>
            </RadioGroup>
          </div>
          {formData.clientType === "individual" && (
            <p className="text-xs text-muted-foreground bg-muted/50 rounded-md px-3 py-2">
              Individual quotation — no company bill-to name required. The quotation will display a generic recipient.
            </p>
          )}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center space-x-2">
            ...
            <Label htmlFor="isTaxDocument" className="cursor-pointer">
              Label as <span className="font-semibold">Tax Quotation</span> (uncheck for plain &quot;Quotation&quot;)
            </Label>
          </div>
          <div className="flex items-center space-x-2">
            <Checkbox
