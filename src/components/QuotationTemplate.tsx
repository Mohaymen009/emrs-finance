      ...
      <div ref={ref} className="quotation-template">
        ...
        <div style={pageStyle}>
          ...
          >
            ...
            >
              {data.isTaxDocument ? "Tax Quotation" : "Quotation"}
            </h1>
          </div>
          ...
          >
            <div style={{ fontSize: "12px", lineHeight: "1.6" }}>
              <div>
                <span style={{ color: "#718096" }}>Quotation number</span>{" "}
                <span style={{ color: "#2b6cb0", fontWeight: "600" }}>{data.quotationNumber || "—"}</span>
              </div>
              <div>
          ...
          >
            <div style={{ width: "250px" }}>
              ...
              >
                <span style={{ color: "#1e3a5f" }}>Total (Incl. VAT)</span>
        ...
        {/* Page 2 - Bank Account Details (Same as Invoice) */}
        <div style={pageStyle}>
          {/* Decorative Corner */}
          <div
            style={{
